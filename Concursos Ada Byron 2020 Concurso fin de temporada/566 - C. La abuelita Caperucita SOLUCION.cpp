...
// La diferencia con el principal es el uso del DFS para bloquear caminos y comprobar si se puede por BFS, de esta forma eliminas los problemas de bloqueos entre caminos